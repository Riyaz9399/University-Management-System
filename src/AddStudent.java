...
public class AddStudent extends JFrame implements ActionListener{
    ...
    public AddStudent(){
        ...
        // Roll number lable 
        rollNumberJLabel = new JLabel("1533" + firstFour);
        rollNumberJLabel.setBounds(200,200,150,30);
        rollNumberJLabel.setFont(new Font("serif",Font.BOLD,20));
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == submit){
            ...
            String rollNumTxt = rollNumberJLabel.getText();
            ...
            String course = (String) cbCource.getSelectedItem();
            String Branch = (String) cbBranch.getSelectedItem();
            String Aadhaar = AadharNumberField.getText();

            try{
                String query = "INSERT INTO `student`(`name`, `fathername`, `rollno`, `dob`, `address`, `phone`, `email`, `Class_X`, `Class_XII`, `Course`, `Branch`,`aadhar`) VALUES ('"+ nameTxt +"','"+ fatherTxt +"','"+ rollNumTxt +"','"+ dob +"','"+ address +"','"+ phone +"','"+ email +"','"+ X +"','"+ XII +"','"+ course +"','"+ Branch +"','"+ Aadhaar +"')";
